...
public class PlayerStats : MonoBehaviour {
    ...
    {
        int end_damage = Mathf.RoundToInt(damage * (1 - (float)(armor / 100)));
    ...
    public void SetArmor(int added_armor, int added_durability, int id)
    {
        armor = added_armor;
    ...
    public void SaveStats()
    {
        ...
        GlobalControl.Instance.durability = armor_durability;

        GlobalControl.Instance.armor_id = armor_id;
    }
